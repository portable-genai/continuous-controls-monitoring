...
#         enabled with review_routing_enabled, because the service refuses to boot with routing
#         on and no console named. A deploy that would ship R8 unwired fails at plan time.
#
