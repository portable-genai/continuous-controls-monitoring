...
read
    ...
    bind_profile == local AND profile chosen AND CCM_S2S_TOKEN unset
...
from continuous_controls_monitoring.adapters.local.identity import (
    LocalIdentityAdapter,
)
from continuous_controls_monitoring.adapters.onprem.identity import (
