...
def build_monitoring_service(container: Container) -> MonitoringService:
    """Wire a MonitoringService from a container's real local ports (no bespoke doubles)."""
...
@pytest.fixture()
def monitoring_service(container: Container) -> MonitoringService:
    return build_monitoring_service(container)
