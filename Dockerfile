# Continuous Controls Monitoring (continuous-controls-monitoring) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    CCM_PROFILE=gcp \
    CCM_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "python -m continuous_controls_monitoring.managed_readiness && exec uvicorn continuous_controls_monitoring.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
